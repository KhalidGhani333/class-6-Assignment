    ...
    <div>
      ...
      <div className="relative bg-[url('/worldpicture.jpg')] bg-cover h-screen">
        ...
        <div className='relative z-10 flex flex-col justify-center items-center text-white'>
          <h1 className='text-4xl text-center font-bold md:mt-10'>Explore the World with Travel Envy✈️</h1>
          <p className='mt-5 md:mt-20 w-[70vw] '>Are you ready to embark on a journey filled with adventure, culture, and breathtaking landscapes? At Your Travel Envy🌍✈️, we specialize in turning your travel dreams into reality!
        ...
        <h2 className='font-bold text-xl text-center md:mt-10'>Contact us today, and lets make your next travel experience unforgettable!</h2>

         
          <div className=" flex flex-col sm:flex-col md:flex-row mt-6 md:mt-10 mx-auto justify-around gap-y-2 sm:gap-x-10">
