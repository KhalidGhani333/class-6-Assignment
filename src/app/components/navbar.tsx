...
const Navbar = () => {
  return (
    <div>
      <div className='flex flex-col sm:flex-row md:justify-between mx-auto justify-around items-center font-bold h-16 bg-sky-300'>
        <div className='md:justify-start text-3xl ml-5 text-white text-center '>Travel Envy</div>
      <div className='flex gap-3 md:gap-8  md:mr-36 text-white mx-auto mr-auto'>
